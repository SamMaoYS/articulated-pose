...
if __name__ == "__main__":
    ...
    baseline_file = my_dir + "/results/pickle/{}/{}_{}_{}_rt_pn.pkl".format(
        test_exp, args.domain, "ANCSH", args.item
    )
    pn_gt_file = my_dir + "/results/pickle/{}/{}_{}_{}_rt.pkl".format(
        test_exp, args.domain, "ANCSH", args.item
    )
    gn_gt_file = my_dir + "/results/pickle/{}/{}_{}_{}_rt.pkl".format(
        test_exp, args.domain, "NAOCS", args.item
    )
    ...
    for k in range(30):
        curr_file = "{}_{}_{}_{}_rt_ours_{}_{}.pkl".format(
            npcs_exp, args.domain, args.nocs, args.item, choose_threshold, k
        )
    ...
    for i in pbar:
        ...
        try:
            ...
            for key in ["baseline", "nonlinear"]:
                ...
                f = h5py.File(
                    my_dir + "/results/test_pred/{}/{}.h5".format(npcs_exp, basename),
                    "r",
                )
                ...
                assert len(iou_per_part) == num_parts, print(
                    "Only get ", len(iou_per_part)
                )
