...
def solver_ransac_nonlinear(
    ...
    print(
        "working on ",
        my_dir
        + "/results/test_pred/{}/ with {} data".format(test_exp, len(test_group)),
    )
    ...
    for i in range(s_ind, e_ind):
        ...
        for j in range(0):
            ...
            print(
                ...
                % (j, rdiff, tdiff, sdiff, np.sum(best_inliers), best_inliers.shape[0])
            )
        ...
        for j in range(1, num_parts):
            ...
            if j == 1:
                print(
                    ...
                    % (
                        ...
                        tdiff0,
                        sdiff0,
                        np.sum(best_inliers[0]),
                        best_inliers[0].shape[0],
                    )
                )
            ...
            print(
                ...
                % (
                    ...
                    tdiff1,
                    sdiff1,
                    np.sum(best_inliers[1]),
                    best_inliers[1].shape[0],
                )
            )
