    ...
    for i in range(num):
        ...
        for link in member_part.findall("link"):
            ...
            if link.findall("inertial") == []:
                ...
                node_inertial = XML(
                    """<inertial><origin rpy="0 0 0" xyz="0 0 0"/><mass value="3.0"/><inertia ixx="0.9" ixy="0.9" ixz="0.9" iyy="0.9" iyz="0" izz="0.9"/></inertial>"""
                )
...
if __name__ == "__main__":
    base_path = (
        "/home/sam/Development/motionnet/articulated-pose/dataset/sapien/urdf/drawer"
    )
